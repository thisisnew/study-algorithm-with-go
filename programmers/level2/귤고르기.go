...
func 귤고르기(k int, tangerine []int) int {
	...
	return len(getCountsMoreThanMinCount(k, getMinCountTangerines(k, counts), tangerineBasket))
}
...
func getCountsMoreThanMinCount(k, minCount int, tangerineBasket map[int]int) []int {
	var result []int
